...
const rbaStateData = {
  ...
  'US-WA': {
    ...
    countyRegionMapping: {
        ...
        Pierce: 'Puget Trough',
        'San Juan': 'North Cascades',
        Skagit: 'North Cascades',
        Skamania: 'West Cascades',
        Snohomish: 'Puget Trough',
        Spokane: 'Columbia Plateau',
        Stevens: 'Canadian Rocky Mountains',
        Thurston: 'Puget Trough',
    ...
    regionChannelMapping: {
      'Blue Mountains': ['1446751898576097362'],
